              ...
              <div className="projects-content">
                ...
                <div className="projects-grid">
                  ...
                  <div className="project-card">
                    ...
                    <p className="project-description">A modern automotive marketplace showcasing cars and listings with a clean UI and powerful search.</p>
                    <div className="project-tech">
                      <span className="tech-tag">React</span>
                      <span className="tech-tag">Next.js</span>
                      <span className="tech-tag">API</span>
                    </div>
                    <a href="https://carnomia.com/" target="_blank" rel="noopener noreferrer" className="project-link">
                      🔗 Visit Website
                    </a>
                  </div>
                </div>
